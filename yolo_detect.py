...
if __name__ == '__main__':
    ...
    # yolo.close_session()
    #strat1=timer()
    dirname="C:/Users/hj123/Desktop/mAP-master/input/images-optional/" ##该目录为测试照片的存储路径，每次测试照片的数量可以自己设定
    ...
    for filename in pic_list:
        ...
        new_f=open("C:/Users/hj123/Desktop/mAP-master/input/detection-results/"+tmp_file.replace(".jpg", ".txt"), "a")  #预测坐标生成txt文件保存的路径
